...
{% hint style="info" %}
Подробнее о работе с блоками "Не состояние" рассказали в статье [в одноименной статье. ](../tipy-blokov/bloki-ne-sostoyanie.md)
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/image (72) (1) (1) (1).png" alt=""><figcaption><p>Виды поддерживаемых мессенджеров</p></figcaption></figure>

Дальше необходимо нажать на кнопку с требуемым мессенджером. О том, как подключить ботов в разных мессенджерах, написано в разделе "[Мессенджеры](../../podklyuchenie-messendzherov-i-kanalov/)"
