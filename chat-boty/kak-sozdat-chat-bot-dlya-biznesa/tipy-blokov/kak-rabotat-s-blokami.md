...
{% hint style="info" %}
Подробнее о каждом типе блока рассказали в статьях ["Блоки с условием](bloki-s-usloviem/)", "[Блоки Не состояние](bloki-ne-sostoyanie.md)", "[Блоки без условия](bloki-bez-usloviya.md)".
{% endhint %}
