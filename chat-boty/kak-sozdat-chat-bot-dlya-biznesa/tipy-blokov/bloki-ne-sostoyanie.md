...
По своим функциям данный вид блока аналогичен блоку [Стартовое условие](bloki-s-usloviem/) с той лишь разницей, что клиент в этот блок не попадает.
...
Не состояние — это серый блок. У него нет условия как в блоке [Состояние диалога](bloki-bez-usloviya.md#blok-sostoyanie-dialoga), но в него нельзя перейти.&#x20;
...
Полный список регулярных выражений можно найти в статье "[Список полезных регулярных выражений](../../peremennye-i-funkcii/spisok-poleznykh-regulyarnykh-vyrazhenii.md)".
{% endhint %}
