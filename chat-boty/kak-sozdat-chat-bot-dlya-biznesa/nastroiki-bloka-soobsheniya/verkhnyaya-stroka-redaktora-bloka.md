...
Поле, которое отвечает за выбор типа блока. Подробнее о типах блоков читайте [в данной **статье**](vkladka-knopki/tipy-knopok.md)
...
&#x20;\
От блока "Введи номер телефона идут две стрелки: [стрелка со сбором данных](../strelki-soedineniya/tipy-soedinenii-strelok.md#strelka-so-sborom-dannykh) к блоку "Твой номер... "  и стрелка [с пустым условием](../strelki-soedineniya/tipy-soedinenii-strelok.md#strelka-s-usloviem) к блоку "Попробуй еще раз".\
\
В стрелке со сбором данных в поле Условие указываем [регулярное выражение](../../peremennye-i-funkcii/kalkulyator/dlya-raboty-s-regulyarnymi-vyrazheniyami.md) - условие, с помощью которого бот может проверять формат введенных данных: пользователь ввел именно номер телефона или что-то иное. \
\
