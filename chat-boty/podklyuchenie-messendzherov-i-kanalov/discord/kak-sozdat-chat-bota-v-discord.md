...
{% hint style="success" %}
Подробнее о том, как создать чат-бота, рассказали в разделе "[Как создать чат-бот для бизнеса](../../kak-sozdat-chat-bot-dlya-biznesa/)".
{% endhint %}

{% hint style="success" %}
Подробнее о том, как создать включить AI-ассистента, рассказали в разделе "[AI-ассистент](../../ai-assistent.md)".
{% endhint %}
