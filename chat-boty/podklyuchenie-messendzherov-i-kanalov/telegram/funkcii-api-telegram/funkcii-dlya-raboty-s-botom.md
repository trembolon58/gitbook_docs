...
<figure><img src="../../../../.gitbook/assets/image (85) (1).png" alt=""><figcaption><p>Настройка блока в Salebot: используются функции для установки команды и описания</p></figcaption></figure>

После запуска (проводите это единожды по команде администратора):

<figure><img src="../../../../.gitbook/assets/image (86) (1).png" alt=""><figcaption><p>Приветственное сообщение и меню бота</p></figcaption></figure>
