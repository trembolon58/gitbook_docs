...
{% hint style="info" %}
Какие переменные могут быть созданы при оплате, читайте в инструкциях по подключению платежных сервисов в разделе "[Эквайринг](../../integracii/platezhnye-sistemy/)".
{% endhint %}
