...
{% hint style="success" %}
Подробно о том, как настроить ответ на комментарий в директ (ответ в виде сообщения в директ на комментарий) [мы рассказали в разделе выше.](avtomatizaciya-instagram.md#nastroika-avtootveta-v-direkt)
{% endhint %}
...
{% hint style="success" %}
Подробнее о настройке [автоответов в директ рассказали выше.](avtomatizaciya-instagram.md#nastroika-avtootveta-v-direkt)
{% endhint %}

### Добавить действие

{% hint style="success" %}
Как добавить действие в автоответ, [рассказали выше.](avtomatizaciya-instagram.md#dobavit-deistvie)
{% endhint %}
