...
\- [tg\_send\_chat\_action](api/group.md#kak-pokazat-deistviya-v-chate-kanale-telegram)

\- [tg\_send\_message](api/messages.md#otpravit-soobshenie-v-telegram)

\- [tg\_send\_poll](business.md#tg_send_poll)

\- [tg\_send\_quiz\_poll](business.md#tg_send_quiz_poll)

\- [tg\_send\_video\_note](api/attachments.md)

\- [tg\_send\_sticker](api/attachments.md)

\- [tg\_send\_contact](api/attachments.md)

\- [tg\_send\_venue](api/attachments.md)

\- [tg\_send\_video](api/attachments.md)

\- [tg\_send\_animation](api/attachments.md)

\- [tg\_send\_voice](api/attachments.md)

\- [tg\_send\_document](api/attachments.md)

\- [tg\_send\_media\_group](api/attachments.md)

\- [tg\_send\_some\_photo](api/attachments.md)

\- [tg\_send\_some\_video](api/attachments.md)

-[ tg\_send\_some\_document](api/attachments.md)

\- [tg\_send\_some\_audio](api/attachments.md)

\- [tg\_send\_dice ](api/attachments.md)

автоматически работают с клиентами, написавшими в бизнес аккаунт телеграм так же, как в ботах.

{% hint style="info" %}
Подробнее об указанных методах написано в статье "[API Telegram](api/)".
{% endhint %}
