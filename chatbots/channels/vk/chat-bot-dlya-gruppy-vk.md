...
<img src="../../../.gitbook/assets/image (166) (1).png" alt="Авторизация Вконтакте для получения списка групп, в которых Вы являетесь Администратором" width="563">
...
{% hint style="success" %}
Подробно о том, как проверить подписку на сообщество с помощью чат-бота, рассказали в статье "[API вконтакте](api-vkontakte/)".
{% endhint %}
