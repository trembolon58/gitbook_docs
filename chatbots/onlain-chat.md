...
<figure><img src="../.gitbook/assets/для онлацн чата.png" alt=""><figcaption></figcaption></figure>

## Как создать онлайн-чат

Для создания чата перейдите в пункт меню "Каналы" и нажмите на кнопку "Online-chat".

<figure><img src="../.gitbook/assets/Снимок экрана 2025-06-27 в 13.52.14.png" alt=""><figcaption></figcaption></figure>

Сразу после клика по кнопке "Online-chat" откроется форма настроек созданного онлайн-чата.

Внешний вид чата будет отличаться в зависимости от настроек. В правой панели отображается внешний вид чата, который вы создали, его можно открыть и закрыть.&#x20;

### Как установить онлайн-чат на сайт

Чтобы установить онлайн-чат на сайт, необходимо скопировать скрипт во вкладке код:

<figure><img src="../.gitbook/assets/2024-03-11_15-33-37.png" alt="" width="563"><figcaption></figcaption></figure>

Затем вставить данный код в настройках сайта в поле HTML-код head:

<figure><img src="../.gitbook/assets/2024-03-11_15-37-02.png" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
**Вставьте данный код на каждую страницу вашего сайта внутри тега \<head>**.
{% endhint %}

&#x20;На этом подключение онлайн-чата к сайту завершено.

## Основные настройки

### Оформление

<figure><img src="../.gitbook/assets/2024-03-11_15-44-43.png" alt="" width="563"><figcaption></figcaption></figure>

#### Заголовок чата

В этом поле прописывается наименование для онлайн-чата - самое верхнее поле.&#x20;

<div><figure><img src="../.gitbook/assets/2024-03-11_15-47-40.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/2024-03-11_15-48-18.png" alt="" width="243"><figcaption></figcaption></figure></div>

#### Подзаголовок чата

Это поле находится ниже, чем заголовок чата, и позволяет Вам уточнить роль онлайн-чата на вашем ресурсе.&#x20;

<div><figure><img src="../.gitbook/assets/2024-03-11_15-49-52.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/2024-03-11_15-50-10.png" alt="" width="260"><figcaption></figcaption></figure></div>

#### Надпись на кнопке виджета

Надпись на кнопке виджета отображается при свернутом состоянии онлайн-чата. По умолчанию отображается текст из полей заголовка и подзаголовка: можно установить другую надпись при необходимости:

<div><figure><img src="../.gitbook/assets/2024-03-11_15-56-35.png" alt="" width="458"><figcaption><p>Поле "Надпись на кнопке виджета" заполнено</p></figcaption></figure> <figure><img src="../.gitbook/assets/2024-03-11_15-56-54.png" alt="" width="440"><figcaption><p>Без заполнения поля "Надпись на кнопке виджета"</p></figcaption></figure></div>

#### Приветственное сообщение в чате

В этом поле заполняется текст предварительного сообщения от бота:&#x20;

<div><figure><img src="../.gitbook/assets/2024-03-11_15-59-11.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/2024-03-11_15-59-31.png" alt="" width="474"><figcaption></figcaption></figure></div>

#### Ориентация текста

С помощью панели ориентации текста можно выравнивать заголовок и подзаголовок онлайн-чата относительно правого, левого края или центра по аналогии с любыми текстовыми редакторами типа Word или Googledoc.

Ориентация по центру:

<div><figure><img src="../.gitbook/assets/2024-03-11_16-02-38.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/2024-03-11_16-02-51.png" alt=""><figcaption></figcaption></figure></div>

Ориентация по левому краю:

<div><figure><img src="../.gitbook/assets/2024-03-11_16-03-20.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/2024-03-11_16-03-04.png" alt=""><figcaption></figcaption></figure></div>
...
<figure><img src="../.gitbook/assets/2024-03-11_16-05-26.png" alt="" width="525"><figcaption></figcaption></figure>

Расположить кнопку можно по правому или левому краю:

<figure><img src="../.gitbook/assets/2024-03-11_16-07-18.png" alt="" width="536"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/2024-03-07_10-28-59.png" alt="" width="525"><figcaption></figcaption></figure>

Безусловно, можно выбрать цвет и яркость узоров, а также иных элементов онлайн-чата. Для этого активируйте чекбокс "Расширенные настройки:

<figure><img src="../.gitbook/assets/2024-03-07_10-30-02.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/2024-03-11_16-12-14.png" alt="" width="563"><figcaption></figcaption></figure>

Также в случае необходимости, можно не отображать аватар чата с помощью данного чекбокса:

<figure><img src="../.gitbook/assets/2024-03-07_10-51-27.png" alt="" width="337"><figcaption></figcaption></figure>

#### Логотип

В настройках можно отображать логотип Salebot:

<figure><img src="../.gitbook/assets/2024-03-11_16-12-46.png" alt=""><figcaption></figcaption></figure>

### Настройки

<figure><img src="../.gitbook/assets/2024-01-05_16-07-02.png" alt="" width="505"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/2024-03-11_11-31-16.png" alt="" width="242"><figcaption></figcaption></figure>

При неактивном положении "Отображать только мессенджеры" вид онлайн-чата будет таким:

<figure><img src="../.gitbook/assets/2024-03-11_11-29-54.png" alt="" width="404"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/2024-03-11_11-34-25.png" alt="" width="441"><figcaption></figcaption></figure>

В настройках можно указать url ссылки и добавить изображение:

<figure><img src="../.gitbook/assets/2024-03-11_11-35-38.png" alt="" width="563"><figcaption></figcaption></figure>

&#x20;**Загрузка файлов**

Данная настройка даёт возможность получать вложения от клиентов сайта, например, изображения.&#x20;

<figure><img src="../.gitbook/assets/2024-03-07_16-45-57.png" alt="" width="410"><figcaption></figcaption></figure>
...
Код нужен на случай, если пользователь совершил какое-либо действие на сайте, и вам нужно отправить сообщение от его имени в чате в этот момент.

`if(window.ChatBotPro) {`\
`window.ChatBotPro.sendMessageFromUser("Сообщение")`\
`}`

Например, когда пользователь нажимает на кнопку, от его имени будет отправлено сообщение.&#x20;

{% hint style="info" %}
На это сообщение можно настроить реакцию в боте.
{% endhint %}

Код вставляется в разделе HTML в настройках сайта:

<div data-with-frame="true"><figure><img src="../.gitbook/assets/Снимок экрана 2026-06-05 в 18.06.43.png" alt=""><figcaption></figcaption></figure></div>
