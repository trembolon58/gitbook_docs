...
{% hint style="info" %}
Как работать с мессенджером Telegram, рассказали в [одноименном разделе](../channels/telegram/)
{% endhint %}
...
Функция[ quiz\_link ](video.md#ssylka-s-uvedomleniem-o-klike)работает ТОЛЬКО для Telegram.
