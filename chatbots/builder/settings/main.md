...
{% hint style="info" %}
Подробнее о работе с блоками "Не состояние" рассказали в статье [в одноименной статье. ](../block_type/fallback.md)
{% endhint %}
...
Дальше необходимо нажать на кнопку с требуемым мессенджером. О том, как подключить ботов в разных мессенджерах, написано в разделе "[Мессенджеры](../../channels/)"
