...
Как собрать схему, рассказали в статье "[Как создать чат-бота](main.md)", как добавить в бот варианты ответов, рассказали в статье "[Варианты ответов в боте"](bot_answer.md)
{% endhint %}
