...
{% hint style="info" %}
Как настроить реакцию бота на колбек перехода по ссылке, читайте ниже в разделе "[Отслеживание клика по ссылке](attachments.md#otslezhivanie-klika-po-ssylke)"
{% endhint %}
...
<img src="../../../.gitbook/assets/image (80) (1) (1) (1).png" alt="Пример использования своего домена для формирования коротких ссылок" width="563">
...
2. Подобнее о том, как разместить ссылку в кнопке, вы можете прочитать в статье "[Кнопки](buttons/type.md#knopki-so-ssylkoi)"
{% endhint %}
