...
{% hint style="info" %}
Подробнее про работу с [Markdown читайте в этой статье.](../markdown.md)
{% endhint %}
...
{% hint style="info" %}
Подробнее о разметке в Telegram рассказали в статье "[Markdown и HTML-разметка в Телеграм](../../channels/telegram/markdown.md)"
{% endhint %}
