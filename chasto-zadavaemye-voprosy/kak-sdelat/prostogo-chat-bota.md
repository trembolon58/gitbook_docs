...
Как подключить и настроить платежные системы для того, чтобы формировать оплату в кнопках (ссылках) в боте, читайте в разделе "Интеграции" → "[Эквайринг](../../integration/payments/)".&#x20;
{% endhint %}
