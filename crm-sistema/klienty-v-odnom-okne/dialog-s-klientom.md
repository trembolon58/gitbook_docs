...
1. _**Тег**_ - Переменная-идентификатор которая позволяет отследить откуда пришел клиент. [Подробно о теге рассказали тут](../../websites/konstruktor-saitov/nastroiki-stranicy-saita.md#teg)
