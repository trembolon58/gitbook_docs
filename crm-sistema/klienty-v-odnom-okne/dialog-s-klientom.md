...
1. _**Тег**_ - Переменная-идентификатор которая позволяет отследить откуда пришел клиент. [Подробно о теге рассказали тут](../../websites/builder/nastroiki-stranicy-saita.md#teg)
