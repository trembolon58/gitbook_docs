...
<figure><img src="/broken/files/9w6Pb3R4ZIMwu83q1vfx" alt=""><figcaption><p>Секретный ключ в настройках формы личного кабинета платежной системы "Продамус"</p></figcaption></figure>
...
<figure><img src="/broken/files/SgR9gmuUuy4GBvg9mNrT" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/K0AqitKqYdwQzMyVhaMN" alt=""><figcaption><p>Настройка url для уведомлений</p></figcaption></figure>
...
<figure><img src="/broken/files/99n43sva8uLYAMV8r4XJ" alt=""><figcaption><p>Настройка url для  уведомлений для оплат по подписке</p></figcaption></figure>
...
<figure><img src="/broken/files/O9eB0Y2ahRy3Rt2FFfdI" alt=""><figcaption><p>Раздел "Эквайринг" → Выбор платежной системы "Продамус"</p></figcaption></figure>

Далее необходимо просто указать данные, о которых говорили выше, в форму:

<figure><img src="/broken/files/BuEaPHPNvWngshU3dhia" alt=""><figcaption><p>Форма платежной системы "Продамус" в разделе "Эквайринг"</p></figcaption></figure>

{% hint style="warning" %}
**ВАЖНО!** url - платежной формы указываем БЕЗ https://&#x20;
{% endhint %}

На этом подключение закончено. Теперь давайте разберемся как использовать данный функционал.<br>
...
<figure><img src="/broken/files/RHHKPGQVRKG9YtB7rqOc" alt="" width="563"><figcaption><p>Окно настроек кнопки</p></figcaption></figure>
...
<figure><img src="/broken/files/lI1dYAi5daxu1KkLDMu3" alt="" width="431"><figcaption><p>Коллбэк после перехода клиентом по ссылке</p></figcaption></figure>
...
<figure><img src="/broken/files/yan6Cwj3eMYvNSpnrTut" alt=""><figcaption><p>Страница оплаты: в кнопке заполнены только основные параметры</p></figcaption></figure>

### Дополнительные параметры формирования ссылки на оплату

<figure><img src="/broken/files/3UvXzZy3SbneGhn9mRGd" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/Rxe9EiXkkqG4mevokYxT" alt=""><figcaption><p>Диалог в разделе "Клиенты"</p></figcaption></figure>

<figure><img src="/broken/files/T2q1H7khQUvqbz2Z6ZpX" alt=""><figcaption><p>Настройка блока "Стартовое условие"</p></figcaption></figure>
...
<figure><img src="/broken/files/knbc959aNntBtqAKHYny" alt=""><figcaption><p>Коллбэк об успешной оплате в поле Условие блока.</p></figcaption></figure>
...
<figure><img src="/broken/files/q1rLe1EO1DKZfJmwZwOu" alt=""><figcaption><p>Пример коллбэка от Продамус для товаров с автоподпиской</p></figcaption></figure>
...
<figure><img src="/broken/files/VFlQApw7PRl5H0D53LpT" alt=""><figcaption></figcaption></figure>
{% endtab %}
...
<figure><img src="/broken/files/6KRkgbSxHAKUFSRGMeLn" alt="" width="524"><figcaption></figcaption></figure>

Пример реализации.

В первом блоке задаем сумму оплаты:

<figure><img src="/broken/files/ktAYZEg2wBkBxxyaNzeM" alt=""><figcaption></figcaption></figure>

Дальше выводим в нужном месте url, ссылку prodamus\_pay\_url:

<figure><img src="/broken/files/ljcZlIjQWjTEvbCYDzXo" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/iTrd0JqFy7TYEbb9ArsK" alt=""><figcaption><p>Настройки страницы оплаты платежной системы "Продамус"</p></figcaption></figure>

<figure><img src="/broken/files/kGKWCM2v4jflhoodrgYV" alt=""><figcaption><p>Варианты оплаты, которые подключены для Вашей страницы</p></figcaption></figure>
...
<figure><img src="/broken/files/PEgPlbo8ZhmFuIJeklMh" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/SkxTDgTQfKlbF7w550IH" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/fvsaSBo7lCzgw2C08J45" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/tSLR78tdJ4BCwq8SmMDl" alt=""><figcaption><p>пример блока для уведомлений о Неуспешной оплате с конкретной причиной</p></figcaption></figure>

Для отправки сообщения **на все неудачные списания, независимо от причины**, можно настроить следующим образом:

<figure><img src="/broken/files/HC3xyquKBRIapM1UndZD" alt=""><figcaption><p>пример блока для уведомлений о Неуспешной оплате с любым пояснением причины</p></figcaption></figure>
...
<figure><img src="/broken/files/RwgMec0XoOfLKadlPTSs" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/nAtXo3GSTdTa0ycNdTtS" alt=""><figcaption></figcaption></figure>
{% endtab %}
...
<figure><img src="/broken/files/WuyJs6eM8A2U9l0nYFjc" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/j19bLSnlp00E7OT0VOL5" alt=""><figcaption><p>Пример использования функции prodamus_subscription_switch_status</p></figcaption></figure>
...
<figure><img src="/broken/files/A5xLebtdzkzSBMwbYT4g" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/broken/files/Q2RAstVcdYRad1Pq71cv" alt=""><figcaption></figcaption></figure>
