...
<div><figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 12.27.17.png" alt="" width="563"><figcaption></figcaption></figure> <figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 12.27.40.png" alt="" width="563"><figcaption></figcaption></figure></div>
...
а) либо перейдите в раздел "[Эквайринг](../../../integration/payments/)" и изучите необходимую инструкцию для подключения:
...
Как настроить тарифы, читайте [в одноименной статье](../../builder/plans.md).&#x20;
{% endhint %}
...
<div><figure><img src="../../../.gitbook/assets/Снимок экрана 2025-07-14 в 12.09.07.png" alt="" width="563"><figcaption></figcaption></figure> <figure><img src="../../../.gitbook/assets/Снимок экрана 2025-07-14 в 12.10.26.png" alt="" width="563"><figcaption></figcaption></figure></div>

ID тарифа найти довольно-таки просто: он уже виден на карточке в разделе:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2025-07-14 в 12.11.03.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Запись-экрана-2025-07-14-в-12.11.34-_online-video-cutter.com_.gif" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 13.54.53.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.00.39.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.03.41.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Запись-экрана-2024-07-03-в-14.25.00.gif" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.54.39.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.58.08.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.29.38.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.31.26.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.34.15.png" alt=""><figcaption></figcaption></figure>

Шаг 2. В этом же блоке указываем через калькулятор доступные тарифы в курсе:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.38.23.png" alt=""><figcaption></figcaption></figure>

Вместо конструкции #{айди вашего тарифа} укажите ID тарифа в калькуляторе, которые существуют в вашем проекте:&#x20;

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.41.39.png" alt="" width="563"><figcaption></figcaption></figure>

Шаг 3. Создаем кнопки в стрелке для выбора тарифа.&#x20;

Для этого из блока с калькулятором протягиваем две стрелки:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.44.47.png" alt="" width="563"><figcaption></figcaption></figure>

Далее в настройках стрелки прописываем название тарифа:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.46.41.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 14.50.40.png" alt="" width="563"><figcaption><p>Пример клавиатурных кнопок</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.04.46.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.15.17.png" alt="" width="563"><figcaption></figcaption></figure>

Шаг 2. Создаем кнопку оплаты в блоке:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.20.39.png" alt="" width="563"><figcaption></figcaption></figure>

Кликните на "Добавить" кнопку, после чего откроется окно модальной формы:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.21.35.png" alt="" width="563"><figcaption></figcaption></figure>

Где в поле URL необходимо прописать переменную через конструкцию #{}, в которой лежит Ваша ссылка на оплату:

<div><figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.22.22.png" alt="" width="563"><figcaption><p>Переменная в конструкции #{} для направления ссылки на оплату</p></figcaption></figure> <figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.23.18.png" alt="" width="563"><figcaption><p>Переменная, в которой лежит ссылка на оплату</p></figcaption></figure></div>

Если вы сделали все верно, то при тестировании вам откроется страница оплаты:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.26.19.png" alt="" width="563"><figcaption></figcaption></figure>

Страница оплаты при нажатии на кнопку:

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.27.06.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/rezz.jpg" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.34.51.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.47.49.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.52.12.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-07-03 в 15.55.30.png" alt="" width="563"><figcaption></figcaption></figure>
