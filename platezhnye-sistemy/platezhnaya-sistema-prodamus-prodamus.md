...
| **products\_for\_receipt** | <p><strong>Строка от 50 до 4000 символов в формате</strong> "описание заказа - стоимость - ссылка на приобретаемый ресурс”. </p><p>Например:</p><p>“Курс ‘Рыбалка на леща’, стоимость 4999 рублей, ссылка на страницу курса: https://www.lovilescha.ru/courses/poimai_kilogram/". </p><p><mark style="color:red;"><strong>Обязательный</strong></mark>, если у вас нет своей онлайн кассы, для фискализации оплат через Prodamus. </p><p></p><p>Также вместо текста с описанием заказа, в параметр products_for_receipt можно передать данные для чека в виде списка словарей. Например: [{"name":"Мой товар", "quantity": 1, "price": 500, "object": "goods"}]</p><p></p><p>Описание данных для чека:</p><ul><li>name – наименование товара. Обязательный параметр при передаче данных для чека</li><li>price – цена товара. Обязательный параметр при передаче данных для чека</li><li>quantity – количество товара. Обязательный параметр при передаче данных для чека</li><li>type – Категория товара. Возможные значения - course - Доступ к курсу, service - Услуга, goods - Товар. </li></ul><p>(необязательный параметр)</p> |
