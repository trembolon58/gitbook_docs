...
<summary><mark style="color:green;">POST</mark> https://chatter.salebot.pro/api/#{api_key}/max_callback</summary>

URL запроса: https://chatter.salebot.pro/api/#{api\_key}/max\_callback
...
**platform\_id** - Идентификатор чата в MAX
...
send\_time - дата и время в формате "%Y-%m-%d %H:%M:%S" ("2024-10-16 13:15:59"). Позволяет указать дату и время для отправки сообщения. Если указать time\_shift и send\_time одновременно, будет использован time\_shift
